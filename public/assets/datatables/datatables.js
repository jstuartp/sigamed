 ...
 *   https://datatables.net/download/#bs5/dt-1.11.5/b-2.2.2/date-1.1.2/r-2.2.9/sp-2.0.0
 *
 * Included libraries:
 *   DataTables 1.11.5, Buttons 2.2.2, DateTime 1.1.2, Responsive 2.2.9, SearchPanes 2.0.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs5/dt-1.11.5/b-2.2.2/date-1.1.2/r-2.2.9/sp-2.0.0",
