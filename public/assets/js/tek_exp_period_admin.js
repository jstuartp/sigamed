            ...
            function(data){
                if(data.error === true) {
                    ...
                    for(i=0; i<data.courses.length; i++) {
                        ...
                        $html += '    <div class="right icon button imageButton deleteButton deleteCourse" style="height: 16px;" title="Eliminar"  rel="' + data.courses[i].id + '"><i class="fas fa-trash"></i></div>';
